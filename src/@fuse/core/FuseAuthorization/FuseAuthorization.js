...
class FuseAuthorization extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    return (
      ...
      nextProps.account.pending !== this.props.account.pending
    );
  }

  componentDidUpdate() {
    if (this.props.account.pending) {
...
const mapStateToProps = (state) => ({
  account: state?.authentication?.accountconfirmation || {},
});

export default connect(mapStateToProps)(withRouter(FuseAuthorization));
