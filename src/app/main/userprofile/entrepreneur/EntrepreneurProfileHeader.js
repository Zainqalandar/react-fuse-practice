...
import { selectEntrepreneur } from './store/entrepreneurSlice';

const EntrepreneurProfileHeader = ({ selectedTab, setSelectedTab }) => {
  const user = useSelector(selectEntrepreneur);
...
export default EntrepreneurProfileHeader;
